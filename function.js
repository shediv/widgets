...
function calculateResults() {
  ...
  let overs_bowled = document.getElementById("overs_bowled");
  ...
  if (matches_count && run_scored && overs_played && run_given) {
    ...
    // Bowling
    let bowlingNRR = (run_given/(matches_count*overs_per_match_count));

    // nrr
    let totalNRR = battingNRR - bowlingNRR;

    // Set NRR values
    overs_bowled.value = matches_count*overs_per_match_count;
